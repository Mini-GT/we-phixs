...
export default function ProfileMotion({ cardRef }: { cardRef: RefObject<HTMLDivElement | null> }) {
  ...
  return (
    <MotionComponent>
      <Card
        ref={cardRef}
        className={`relative w-[95vw] max-w-[600px] ${user?.discord?.username ? "max-h-[785px]" : "max-h-[640px]"} overflow-y-auto scrollbar-custom p-6 bg-white border-cyan-300 rounded-4xl`}
      >
